...
////CAPAS//////////
GeoMapAdmin.prototype.CrearMapa = function(target, center, zoom) {
	var _target = target || 'map',
		_center = center || [-56.165947, -34.890480],
		_zoom = zoom || 30;

	this.map = new ol.Map({
		target: _target,
		layers: [lyrOSM, lyrServicios], // lyrLinea2, lyrPunto2, lyrZonas2, lyrUsuario, lyrEjes
		view: new ol.View({
...
GeoMapAdmin.prototype.updateGeoserverLayer = function(cqlFilter) {
	lyrPunto2.getSource().updateParams({
		'CQL_FILTER': cqlFilter
	});
};

GeoMapAdmin.prototype.CrearControlBarra = function() {
...
GeoMapAdmin.prototype.CrearBarraBusquedaCalleNumeroSeparado = function() {
	var self = this;
...
GeoMapAdmin.prototype.CrearControlBarraDibujo = function() {
	var self = this;
...
GeoMapAdmin.prototype.CrearControlBarraDibujoServicio = function() {
	var self = this;
